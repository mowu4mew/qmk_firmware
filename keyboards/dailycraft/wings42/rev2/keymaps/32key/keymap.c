...
#define MT_GUI_T LGUI_T(KC_T)
#define MT_GUI_E RGUI_T(KC_E)
#define MT_SFT_H LSFT_T(KC_H)
#define MT_SFT_L RSFT_T(KC_L)
#define MT_CTL_K LCTL_T(KC_K)
#define MT_CTL_Y RCTL_T(KC_Y)
#define MT_ALT_O LALT_T(KC_O)
...
const uint16_t PROGMEM oe_combo[] = {MT_ALT_O, MT_GUI_E ,COMBO_END};
const uint16_t PROGMEM st_combo[] = {MT_ALT_S, MT_GUI_T, COMBO_END};
const uint16_t PROGMEM ea_combo[] = {MT_GUI_E, KC_A, COMBO_END};
const uint16_t PROGMEM dl_combo[] = {KC_DOWN, KC_LEFT, COMBO_END};
const uint16_t PROGMEM tn_combo[] = {MT_GUI_T, KC_N, COMBO_END};
const uint16_t PROGMEM dc_combo[] = {JP_DOT, JP_COMM, COMBO_END};
const uint16_t PROGMEM xi_combo[] = {KC_X, KC_I, COMBO_END};

combo_t key_combos[COMBO_COUNT] = {
  [OE_HENK] = COMBO(oe_combo, JP_HENK),
  [ST_MHEN] = COMBO(st_combo, JP_MHEN),
  [EA_TAB] = COMBO(ea_combo, KC_TAB),
  [DL_TAB] = COMBO(dl_combo, KC_TAB),
  [TN_ESC] = COMBO(tn_combo, KC_ESC),
  [DOT_COLON_MBTN3] = COMBO(dc_combo, MBTN3),
  [XI_LOCK] = COMBO(xi_combo, MC_LOCK)
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_NOB] = LAYOUT_split_3x6_3_2(
  //,-----------------------------------------------------|                  |-----------------------------------------------------.
     XXXXXXX,TD(TD_Q_ESC), KC_W,    KC_M,    KC_R,    KC_V,                       KC_J,    KC_U,    KC_I,    KC_X,    KC_P, XXXXXXX,
  //|--------+--------+--------+--------+--------+--------|                  |--------+--------+--------+--------+--------+--------|
      XXXXXXX,MT_CTL_K,MT_ALT_S,MT_GUI_T,    KC_N,    KC_G, _______, _______, MT_FNC_F,    KC_A,MT_GUI_E,MT_ALT_O,MT_CTL_Y, XXXXXXX,
  //|--------+--------+--------+--------+--------+--------|                  |--------+--------+--------+--------+--------+--------|
      XXXXXXX,    KC_Z,    KC_D,    KC_C,MT_SFT_H,    KC_B, _______, _______,  JP_MINS,MT_SFT_L, JP_COMM,  JP_DOT, JP_SLSH,XXXXXXX,
  //|--------+--------+--------+--------+--------+--------|                  |--------+--------+--------+--------+--------+--------|
  ...
  switch (keycode) {
    case CMD_SPC:
      if(record->event.pressed){
        ...
        layer_on(_CMD);
        update_tri_layer(_NUM, _CMD, _NOB);
        if(IS_LAYER_ON(_NOB)){
          layer_off(_CMD);
          layer_off(_NUM);
